...
const Navigation = styled.div`
    ${tw`w-full bg-neutral-900 shadow-md overflow-x-auto h-24 flex items-center`};
...
const RightNavigation = styled.div`
    ...
    .discord {
        & svg path {
            ${tw`fill-current text-neutral-300`};
        }
    }
    
    .discord:active, .discord:hover {
        & svg path {
            ${tw`fill-current text-neutral-100`};
        }
    }
        ...
        <Navigation>
            <div css={tw`mx-auto w-full flex items-center`} style={{ maxWidth: '1200px', height: '3.5rem' }}>
                <div id={'logo'}>
                    <Link to={'/'}>
                        {/* {name} */}
                        <img css={tw`block w-40`} src={'https://cdn.discordapp.com/attachments/745780094567579730/745781925377212467/breathe__1_-removebg-preview_2.png'} />
                    </Link>
                </div>
                <RightNavigation>
                    <SearchContainer/>
                    <a className={'discord'} style={{padding: 0}} href={'https://discord.gg/pzW74rekPS'} target={'_blank'} rel={'noreferrer'}>
                        <svg css={tw`h-4`} width="71" height="55" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
